...
//	            	toastr["success"]("登录成功！");
					...
					$.cookie("access_token", data.res.access_token, { expires: 1  , path: '/XuantiServer/static/student'});
					$.cookie("refresh_token", data.res.refresh_token, { expires: 1  , path: '/XuantiServer/static/student'});  
					$.cookie("permission", data.res.permission, { expires: 1  , path: '/XuantiServer/static/student'});
                	window.location.href="html/xuanti.html?ver=2021.4.25";
                }else {
                	console.log(data);
