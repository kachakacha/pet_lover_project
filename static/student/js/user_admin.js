$(function () {  
	$('.import-btn').change(function () {
          ...
          formData.append('operation_type', 'admin')
          console.log("akdmx,kjffj")
          $.ajax({
   ...
   //头文件
    ...
    $(document).on('click', '#email_add', function() {
		...
		var paword = $('input[name="password"]').val();
